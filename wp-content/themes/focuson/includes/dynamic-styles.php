...
/*-------------------------*/
	...
	$nz_h1_desk_menu_m                   = (class_exists( 'ReduxFramework' )) ? (isset($GLOBALS['focuson_ninzio']['h1-desk-menu-m']) && !empty($GLOBALS['focuson_ninzio']['h1-desk-menu-m'])) ? $GLOBALS['focuson_ninzio']['h1-desk-menu-m'] : '0' : '20';
...
/*-------------------------*/
	...
	#projects-load-more .project-loader:before {
	    border-left: 2px solid <?php echo $GLOBALS['focuson_ninzio']['main-color']; ?>;
	}
