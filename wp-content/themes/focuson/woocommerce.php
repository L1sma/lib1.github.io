...
<?php
	...
	$nz_shop_sidebar        = (isset($GLOBALS['focuson_ninzio']['shop-sidebar']) && !empty($GLOBALS['focuson_ninzio']['shop-sidebar'])) ? $GLOBALS['focuson_ninzio']['shop-sidebar'] : "none";
	$nz_shop_sidebar_single = (isset($GLOBALS['focuson_ninzio']['shop-sidebar-single']) && !empty($GLOBALS['focuson_ninzio']['shop-sidebar-single'])) ? $GLOBALS['focuson_ninzio']['shop-sidebar-single'] : "none";
	$nz_shop_animation      = (isset($GLOBALS['focuson_ninzio']['shop-animation']) && $GLOBALS['focuson_ninzio']['shop-animation'] == 1) ? "true" : "false";
	$nz_shop_rp             = (isset($GLOBALS['focuson_ninzio']['shop-rp']) && $GLOBALS['focuson_ninzio']['shop-rp'] == 1) ? "true" : "false";
	$nz_shop_rpn            = (isset($GLOBALS['focuson_ninzio']['shop-rpn']) && !empty($GLOBALS['focuson_ninzio']['shop-rpn'])) ? $GLOBALS['focuson_ninzio']['shop-rpn'] : 3;
