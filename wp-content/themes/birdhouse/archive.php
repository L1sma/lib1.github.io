					...
					<?php
						...
						-------------------------------------------*/
							...
							elseif ( is_tag() ) {
								...
								if ( tag_description() ) {
									$birdhouse_['out_description'] = wp_kses( tag_description(), $birdhouse_Options['tags_allowed'] ); }

								// Get custom sidebar
								$birdhouse_['value'] = esc_html( 'st_category_sidebar_' . $birdhouse_['term']->term_id );
								$birdhouse_['sidebar'] = esc_html( get_option( $birdhouse_['value'] ) );
							...
							elseif ( is_category() ) {
								...
								$birdhouse_['out_title'] = esc_html( $birdhouse_['category']->name ) . ' <span class="title-sub">' . $birdhouse_['category']->count . '</span>';

								if ( $birdhouse_['category']->category_description ) {
									$birdhouse_['out_description'] = $birdhouse_['category']->category_description; }

								// Get custom sidebar
								$birdhouse_['value'] = esc_html( 'st_category_sidebar_' . $birdhouse_['category']->term_id );
								$birdhouse_['sidebar'] = esc_html( get_option( $birdhouse_['value'] ) );
